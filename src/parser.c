...
enum ts_symbol_identifiers {
  ...
  anon_sym_PERCENTendif = 7,
  aux_sym_tags_token1 = 8,
  anon_sym_AutoProv = 9,
  anon_sym_AutoReq = 10,
  anon_sym_AutoReqProv = 11,
  anon_sym_BugUrl = 12,
  anon_sym_BuildRoot = 13,
  anon_sym_BuildSystem = 14,
  anon_sym_DistTag = 15,
  anon_sym_Distribution = 16,
  anon_sym_Epoch = 17,
  anon_sym_Group = 18,
  anon_sym_License = 19,
  anon_sym_ModularityLabel = 20,
  anon_sym_Name = 21,
  anon_sym_NoPatch = 22,
  anon_sym_NoSource = 23,
  anon_sym_Packager = 24,
  anon_sym_Release = 25,
  anon_sym_SourceLicense = 26,
  anon_sym_Summary = 27,
  anon_sym_URL = 28,
  anon_sym_Url = 29,
  anon_sym_VCS = 30,
  anon_sym_Vendor = 31,
  anon_sym_Version = 32,
  aux_sym_tag_token1 = 33,
  aux_sym_tag_token2 = 34,
  anon_sym_pre = 35,
  anon_sym_post = 36,
  anon_sym_postun = 37,
  anon_sym_pretrans = 38,
  anon_sym_posttrans = 39,
  anon_sym_verify = 40,
  anon_sym_interp = 41,
  anon_sym_meta = 42,
  anon_sym_Requires = 43,
  anon_sym_LPAREN = 44,
  anon_sym_RPAREN = 45,
  anon_sym_BuildArch = 46,
  anon_sym_BuildArchitectures = 47,
  anon_sym_BuildConflicts = 48,
  anon_sym_BuildPrereq = 49,
  anon_sym_BuildRequires = 50,
  anon_sym_Conflicts = 51,
  anon_sym_DocDir = 52,
  anon_sym_Enhances = 53,
  anon_sym_ExcludeArch = 54,
  anon_sym_ExcludeOS = 55,
  anon_sym_ExclusiveArch = 56,
  anon_sym_ExclusiveOS = 57,
  anon_sym_Obsoletes = 58,
  anon_sym_OrderWithRequires = 59,
  anon_sym_Prefix = 60,
  anon_sym_Prefixes = 61,
  anon_sym_Prereq = 62,
  anon_sym_Provides = 63,
  anon_sym_Recommends = 64,
  anon_sym_RemovePathPostfixes = 65,
  anon_sym_Suggests = 66,
  anon_sym_Supplements = 67,
  anon_sym_PERCENTdescription = 68,
  anon_sym_DASHn = 69,
  anon_sym_PERCENTpackage = 70,
  anon_sym_PERCENTprep = 71,
  anon_sym_PERCENTgenerate_buildrequires = 72,
  anon_sym_PERCENTconf = 73,
  anon_sym_PERCENTbuild = 74,
  anon_sym_PERCENTinstall = 75,
  anon_sym_PERCENTcheck = 76,
  anon_sym_PERCENTclean = 77,
  anon_sym_PERCENTpre = 78,
  anon_sym_PERCENTpost = 79,
  anon_sym_PERCENTpreun = 80,
  anon_sym_PERCENTpostun = 81,
  anon_sym_PERCENTpretrans = 82,
  anon_sym_PERCENTposttrans = 83,
  anon_sym_PERCENTpreuntrans = 84,
  anon_sym_PERCENTpostuntrans = 85,
  anon_sym_PERCENTverify = 86,
  anon_sym_PERCENTtriggerprein = 87,
  anon_sym_PERCENTtriggerin = 88,
  anon_sym_PERCENTtriggerun = 89,
  anon_sym_PERCENTtriggerpostun = 90,
  anon_sym_PERCENTfiletriggerin = 91,
  anon_sym_PERCENTfiletriggerun = 92,
  anon_sym_PERCENTfiletriggerpostun = 93,
  anon_sym_PERCENTtransfiletriggerin = 94,
  anon_sym_PERCENTtransfiletriggerun = 95,
  anon_sym_PERCENTtransfiletriggerpostun = 96,
  anon_sym_PERCENTfiles = 97,
  anon_sym_DASHf = 98,
  anon_sym_PERCENTdefattr = 99,
  anon_sym_DASH = 100,
  aux_sym_defattr_token1 = 101,
  anon_sym_COMMA = 102,
  aux_sym_defattr_token2 = 103,
  anon_sym_PERCENTartifact = 104,
  anon_sym_PERCENTconfig = 105,
  anon_sym_PERCENTdir = 106,
  anon_sym_PERCENTdoc = 107,
  anon_sym_PERCENTdocdir = 108,
  anon_sym_PERCENTghost = 109,
  anon_sym_PERCENTlicense = 110,
  anon_sym_PERCENTmissingok = 111,
  anon_sym_PERCENTreadme = 112,
  anon_sym_PERCENTattr = 113,
  anon_sym_LPAREN2 = 114,
  anon_sym_filedigest = 115,
  anon_sym_group = 116,
  anon_sym_maj = 117,
  anon_sym_md5 = 118,
  anon_sym_mode = 119,
  ...
  anon_sym_owner = 123,
  anon_sym_size = 124,
  anon_sym_symlink = 125,
  anon_sym_RPAREN2 = 126,
  anon_sym_PERCENTchangelog = 127,
  anon_sym_STAR = 128,
  anon_sym_PERCENTglobal = 129,
  anon_sym_PERCENTdefine = 130,
  anon_sym_PERCENTundefine = 131,
  sym_integer = 132,
  sym_float = 133,
  anon_sym_PERCENT = 134,
  sym_string_content_with_newlines = 135,
  sym_string_content = 136,
  sym_variable_name = 137,
  anon_sym_QMARK = 138,
  anon_sym_PERCENT_LBRACE = 139,
  anon_sym_COLON = 140,
  anon_sym_RBRACE = 141,
  anon_sym_PERCENT_LPAREN = 142,
  sym_spec = 143,
  sym__top_level = 144,
  sym_conditional = 145,
  sym_preamble = 146,
  ...
  sym_tag = 148,
  sym_qualifier = 149,
  sym_dependency_tag = 150,
  aux_sym__value = 151,
  sym_description = 152,
  sym_subsection = 153,
  sym_subsection_package = 154,
  sym_subsection_description = 155,
  sym_prep_scriptlet = 156,
  sym_generate_buildrequires = 157,
  sym_conf_scriptlet = 158,
  sym_build_scriptlet = 159,
  sym_install_scriptlet = 160,
  sym_check_scriptlet = 161,
  sym_clean_scriptlet = 162,
  sym__runtime_scriptlet = 163,
  sym__triggers = 164,
  sym__file_triggers = 165,
  sym_files = 166,
  sym_conditional_files = 167,
  sym_defattr = 168,
  sym_file = 169,
  sym_attr = 170,
  sym_verify = 171,
  sym_changelog = 172,
  sym_changelog_entry = 173,
  sym_macro_definition = 174,
  sym_macro_options = 175,
  sym_macro_undefinition = 176,
  sym_string_with_newlines = 177,
  sym_string = 178,
  sym_single_word = 179,
  sym__macro_expansion = 180,
  sym_simple_expansion = 181,
  sym_full_expansion = 182,
  sym_shell_expansion = 183,
  aux_sym__top_level_repeat1 = 184,
  aux_sym_subsection_package_repeat1 = 185,
  aux_sym_files_repeat1 = 186,
  aux_sym_verify_repeat1 = 187,
  aux_sym_changelog_repeat1 = 188,
  aux_sym_changelog_entry_repeat1 = 189,
  aux_sym_string_with_newlines_repeat1 = 190,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [93] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__top_level_repeat1, 2),
  [95] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__top_level_repeat1, 2), SHIFT_REPEAT(5),
  [98] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__top_level_repeat1, 2), SHIFT_REPEAT(249),
  [101] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__top_level_repeat1, 2), SHIFT_REPEAT(367),
  [104] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__top_level_repeat1, 2), SHIFT_REPEAT(196),
  [107] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__top_level_repeat1, 2), SHIFT_REPEAT(344),
  [110] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__top_level_repeat1, 2), SHIFT_REPEAT(201),
  [113] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__top_level_repeat1, 2), SHIFT_REPEAT(165),
  [116] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__top_level_repeat1, 2), SHIFT_REPEAT(341),
  [119] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__top_level_repeat1, 2), SHIFT_REPEAT(340),
  [122] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__top_level_repeat1, 2), SHIFT_REPEAT(336),
  [125] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__top_level_repeat1, 2), SHIFT_REPEAT(333),
  [128] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__top_level_repeat1, 2), SHIFT_REPEAT(332),
  [131] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__top_level_repeat1, 2), SHIFT_REPEAT(330),
  [134] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__top_level_repeat1, 2), SHIFT_REPEAT(328),
  [137] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__top_level_repeat1, 2), SHIFT_REPEAT(5),
  [140] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__top_level_repeat1, 2), SHIFT_REPEAT(191),
  [143] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__top_level_repeat1, 2), SHIFT_REPEAT(326),
  [146] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__top_level_repeat1, 2), SHIFT_REPEAT(325),
  [149] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__top_level_repeat1, 2), SHIFT_REPEAT(324),
  [152] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__top_level_repeat1, 2), SHIFT_REPEAT(322),
  [155] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__top_level_repeat1, 2), SHIFT_REPEAT(203),
  [158] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__top_level_repeat1, 2), SHIFT_REPEAT(320),
  [161] = {.entry = {.count = 1, .reusable = true}}, SHIFT(7),
  [163] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__top_level, 1),
  [165] = {.entry = {.count = 1, .reusable = false}}, SHIFT(7),
  [167] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__top_level_repeat1, 2), SHIFT_REPEAT(7),
  [170] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__top_level_repeat1, 2), SHIFT_REPEAT(375),
  [173] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__top_level_repeat1, 2),
  [175] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__top_level_repeat1, 2), SHIFT_REPEAT(216),
  [178] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__top_level_repeat1, 2), SHIFT_REPEAT(257),
  [181] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__top_level_repeat1, 2), SHIFT_REPEAT(258),
  [184] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__top_level_repeat1, 2), SHIFT_REPEAT(259),
  [187] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__top_level_repeat1, 2), SHIFT_REPEAT(260),
  [190] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__top_level_repeat1, 2), SHIFT_REPEAT(261),
  [193] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__top_level_repeat1, 2), SHIFT_REPEAT(262),
  [196] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__top_level_repeat1, 2), SHIFT_REPEAT(263),
  [199] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__top_level_repeat1, 2), SHIFT_REPEAT(7),
  [202] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__top_level_repeat1, 2), SHIFT_REPEAT(190),
  [205] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__top_level_repeat1, 2), SHIFT_REPEAT(264),
  [208] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__top_level_repeat1, 2), SHIFT_REPEAT(363),
  [211] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__top_level_repeat1, 2), SHIFT_REPEAT(317),
  [214] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__top_level_repeat1, 2), SHIFT_REPEAT(265),
  [217] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__top_level_repeat1, 2), SHIFT_REPEAT(204),
  [220] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__top_level_repeat1, 2), SHIFT_REPEAT(266),
  [223] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_files, 3),
  ...
  [243] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_files, 2),
  [245] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_files, 3),
  ...
  [253] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_files, 5),
  [255] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_files_repeat1, 2),
  [257] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_files_repeat1, 2),
  [259] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_files_repeat1, 2), SHIFT_REPEAT(247),
  [262] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_files_repeat1, 2), SHIFT_REPEAT(246),
  [265] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_files_repeat1, 2), SHIFT_REPEAT(245),
  [268] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_files_repeat1, 2), SHIFT_REPEAT(161),
  [271] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_files_repeat1, 2), SHIFT_REPEAT(244),
  [274] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_files_repeat1, 2), SHIFT_REPEAT(285),
  [277] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_files_repeat1, 2), SHIFT_REPEAT(148),
  [280] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_files_repeat1, 2), SHIFT_REPEAT(200),
  [283] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_files_repeat1, 2), SHIFT_REPEAT(296),
  [286] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_files, 4),
  [288] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_files, 4),
  [290] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_files_repeat1, 2), SHIFT_REPEAT(376),
  [293] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_files_repeat1, 2), SHIFT_REPEAT(383),
  [296] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_files_repeat1, 2), SHIFT_REPEAT(146),
  [299] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_files, 6),
  [301] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_files, 7),
  [303] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_files, 7),
  [305] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_files, 6),
  [307] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_files, 5),
  [309] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_files, 2),
  [311] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_defattr, 9),
  [313] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_file, 4),
  [315] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_conditional_files, 6),
  [317] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_file, 4),
  [319] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_file, 3),
  [321] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_file, 3),
  [323] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_conditional_files, 6),
  [325] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_file, 2),
  [327] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_defattr, 9),
  [329] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_file, 2),
  [331] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_description, 2),
  [333] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_description, 2),
  ...
  [343] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_prep_scriptlet, 2),
  [345] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_prep_scriptlet, 2),
  [347] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_generate_buildrequires, 2),
  [349] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_generate_buildrequires, 2),
  [351] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_description, 4),
  [353] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_description, 4),
  ...
  [363] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_string_with_newlines_repeat1, 2),
  [365] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_with_newlines_repeat1, 2),
  [367] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_with_newlines_repeat1, 2), SHIFT_REPEAT(215),
  [370] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_with_newlines_repeat1, 2), SHIFT_REPEAT(40),
  [373] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_with_newlines_repeat1, 2), SHIFT_REPEAT(202),
  [376] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_with_newlines_repeat1, 2), SHIFT_REPEAT(286),
  [379] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string_with_newlines, 1),
  [381] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string_with_newlines, 1),
  [383] = {.entry = {.count = 1, .reusable = false}}, SHIFT(40),
  [385] = {.entry = {.count = 1, .reusable = false}}, SHIFT(43),
  [387] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_with_newlines_repeat1, 2), SHIFT_REPEAT(219),
  [390] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_with_newlines_repeat1, 2), SHIFT_REPEAT(43),
  [393] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_with_newlines_repeat1, 2), SHIFT_REPEAT(197),
  [396] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_with_newlines_repeat1, 2), SHIFT_REPEAT(312),
  [399] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_changelog, 3),
  [401] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_changelog, 3),
  [403] = {.entry = {.count = 1, .reusable = false}}, SHIFT(327),
  [405] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_changelog_repeat1, 2),
  [407] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_changelog_repeat1, 2),
  [409] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_changelog_repeat1, 2), SHIFT_REPEAT(241),
  [412] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_changelog, 2),
  [414] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_changelog, 2),
  [416] = {.entry = {.count = 1, .reusable = false}}, SHIFT(241),
  [418] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_changelog_entry_repeat1, 2),
  [420] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_changelog_entry_repeat1, 2),
  [422] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_changelog_entry_repeat1, 2), SHIFT_REPEAT(158),
  [425] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_changelog_repeat1, 2), SHIFT_REPEAT(327),
  [428] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_changelog_entry, 3),
  [430] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_changelog_entry, 3),
  [432] = {.entry = {.count = 1, .reusable = false}}, SHIFT(145),
  [434] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_changelog_entry, 4),
  [436] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_changelog_entry, 4),
  [438] = {.entry = {.count = 1, .reusable = false}}, SHIFT(158),
  [440] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_changelog_entry_repeat1, 2), SHIFT_REPEAT(145),
  [443] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_changelog_entry_repeat1, 3),
  [445] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_changelog_entry_repeat1, 3),
  [447] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_shell_expansion, 2),
  [449] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_shell_expansion, 2),
  [451] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_full_expansion, 3),
  [453] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_full_expansion, 3),
  [455] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_simple_expansion, 2),
  [457] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_simple_expansion, 2),
  [459] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_full_expansion, 4),
  [461] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_full_expansion, 4),
  [463] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_full_expansion, 6),
  [465] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_full_expansion, 6),
  [467] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_full_expansion, 5),
  [469] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_full_expansion, 5),
  [471] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_description, 3),
  [473] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_description, 3),
  [475] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_conditional, 6),
  [477] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_conditional, 6),
  [479] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_subsection_description, 4),
  [481] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_subsection_description, 4),
  [483] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_macro_definition, 5),
  [485] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_macro_definition, 5),
  [487] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_description, 5),
  [489] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_description, 5),
  [491] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tags, 4, .production_id = 1),
  [493] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_tags, 4, .production_id = 1),
  [495] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_macro_definition, 4),
  [497] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_macro_definition, 4),
  [499] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_macro_undefinition, 3),
  [501] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_macro_undefinition, 3),
  [503] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_generate_buildrequires, 3),
  [505] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_generate_buildrequires, 3),
  [507] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_prep_scriptlet, 3),
  [509] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_prep_scriptlet, 3),
  [511] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_subsection, 2),
  [513] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_subsection, 2),
  [515] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_clean_scriptlet, 2),
  [517] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_clean_scriptlet, 2),
  [519] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_check_scriptlet, 2),
  [521] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_check_scriptlet, 2),
  [523] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_install_scriptlet, 2),
  [525] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_install_scriptlet, 2),
  [527] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_build_scriptlet, 2),
  [529] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_build_scriptlet, 2),
  [531] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_conf_scriptlet, 2),
  [533] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_conf_scriptlet, 2),
  [535] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_preamble, 1),
  [537] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_preamble, 1),
  [539] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_subsection_package_repeat1, 2), SHIFT_REPEAT(367),
  [542] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_subsection_package_repeat1, 2), SHIFT_REPEAT(367),
  [545] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_subsection_package_repeat1, 2), SHIFT_REPEAT(196),
  [548] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_subsection_package_repeat1, 2), SHIFT_REPEAT(344),
  [551] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_subsection_package_repeat1, 2), SHIFT_REPEAT(344),
  [554] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_subsection_package_repeat1, 2),
  ...
  [562] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_subsection_package, 4),
  ...
  [574] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__value, 2),
  [576] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__value, 2), SHIFT_REPEAT(128),
  [579] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__value, 2), SHIFT_REPEAT(301),
  [582] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__value, 2), SHIFT_REPEAT(140),
  [585] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__value, 2), SHIFT_REPEAT(198),
  [588] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__value, 2), SHIFT_REPEAT(307),
  ...
  [607] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_attr, 8),
  [609] = {.entry = {.count = 1, .reusable = false}}, SHIFT(131),
  [611] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_verify_repeat1, 2), SHIFT_REPEAT(134),
  [614] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_verify_repeat1, 2),
  ...
  [630] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string, 1),
  [632] = {.entry = {.count = 1, .reusable = false}}, SHIFT(142),
  [634] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2),
  [636] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(301),
  [639] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(142),
  [642] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(198),
  [645] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(307),
  [648] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(295),
  [651] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(143),
  [654] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(199),
  [657] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(302),
  ...
  [670] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(285),
  [673] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(153),
  [676] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(200),
  [679] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2), SHIFT_REPEAT(296),
  ...
  [690] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_verify, 4),
  [692] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_macro_options, 2),
  [694] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_verify, 3),
  ...
  [718] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dependency_tag, 1),
  ...
  [832] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_spec, 1),
  ...
  [844] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dependency_tag, 4),
  ...
  [870] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_qualifier, 1),
  ...
  [880] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_single_word, 1),
  ...
  [1100] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tag, 1),
...
TS_PUBLIC const TSLanguage *tree_sitter_rpmspec() {
